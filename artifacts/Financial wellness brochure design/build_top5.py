# -*- coding: utf-8 -*-
"""Stewardship Collection — Top 5 Featured. Pastor-facing marketing one-pager.
Flourishing design system: navy/gold, Playfair Display / Spectral / Archivo."""
...
def face(family, file, weight, style="normal"):
    return (f"@font-face{{font-family:'{family}';font-style:{style};font-weight:{weight};"
            f"font-display:block;src:url(data:font/ttf;base64,{b64(file)}) format('truetype');}}")
...
CAMPAIGNS = [
    {
        "ac": "#1f3550", "tint": "#edf1f7", "num": "1",
        "title": "Life", "title_em": "Stewardship",
    ...
    {
        "ac": "#1f3a2c", "tint": "#edf4ef", "num": "2",
        "title": "", "title_em": "Entrusted",
    ...
    {
        "ac": "#15403f", "tint": "#eaf4f3", "num": "3",
        "title": "Stewarding", "title_em": "What Matters",
    ...
    {
        "ac": "#46201f", "tint": "#f6ece9", "num": "4",
        "title": "Faithful", "title_em": "Stewardship",
    ...
    {
        "ac": "#4a3a16", "tint": "#f5f0e3", "num": "5",
        "title": "Stewardship", "title_em": "That Lasts",
    ...
    <article class="camp" style="--ac:{c['ac']};--tint:{c['tint']}">
      <div class="camp-band">
        ...
        <div class="camp-head">
          ...
          <h2 class="camp-title">{title_html(c['title'], c['title_em'])}</h2>
        ...
        <div class="camp-side">
          <div class="infobox">
            <ul class="info">
              ...
              <li><span class="ik">Tier</span><span class="iv">Tier 1 — top-demand category</span></li>
            </ul>
          </div>
        </div>
      </div>
...
<title>The Stewardship Collection · Top 5 Featured · Lifetogether</title>
<style>
{FONT_CSS}
  ...
  *{{box-sizing:border-box;}}
  ...
  /* ---------- Through-line ---------- */
  .thru{{padding:60px 70px 56px; background:#fff;}}
  ...
  .arc{{display:grid; grid-template-columns:repeat(5,1fr); gap:12px; margin-bottom:30px;}}
  .arc-step{{background:var(--cream); border:1px solid rgba(0,0,0,.06); border-top:3px solid var(--ac); border-radius:3px; padding:16px 14px;}}
  .arc-n{{font-family:'Playfair Display',serif; font-size:26px; color:var(--ac); line-height:1; margin-bottom:8px;}}
  .arc-t{{font-family:'Archivo',sans-serif; font-size:10px; letter-spacing:.14em; text-transform:uppercase; color:#6f6a5d; margin-bottom:6px;}}
  .arc-d{{font-size:13px; line-height:1.45; color:#3d3a33;}}
  .thru-body p{{font-size:16.5px; line-height:1.72; color:#33312c; margin:0;}}
  ...
  .foot{{background:#0f1a30; color:#8e8straight; padding:22px 70px; }}
  .footer{{background:#0f1a30; color:#8a8button; }}
  ...
  @media print{{
    ...
    .camp{{page-break-inside:avoid;}}
    .cover, .close{{-webkit-print-color-adjust:exact; print-color-adjust:exact;}}
  }}
...
<div class="page">
  ...
  <header class="cover">
    <span class="eyebrow">Lifetogether &middot; The Stewardship Collection &middot; Top Five Featured</span>
    <h1>Nothing here<br><em>is ours.</em></h1>
    <p class="deck">Five flagship campaigns from the Stewardship Collection — each a complete 40-day
    journey with six-session small-group curriculum. Built for the local church and the workplace,
    rooted in Scripture, ready to launch.</p>
    <div class="cover-strip">
      <div><div class="cs-big">5</div><div class="cs-lab">Featured Campaigns</div></div>
      <div><div class="cs-big">40</div><div class="cs-lab">Day Journey Each</div></div>
      <div><div class="cs-big">30</div><div class="cs-lab">Small-Group Sessions</div></div>
      <div><div class="cs-big">2</div><div class="cs-lab">Audiences &middot; Church &amp; Work</div></div>
    </div>
  </header>

  <section class="frame">
    <span class="eyebrow section-eyebrow">Why These Five</span>
    ...
    <div class="frame-intro">
      <p>These five campaigns take stewardship back. Each one takes a distinct door into the same
      conviction — that nothing we hold is finally ours — and each is built to stand alone as a complete
      churchwide series with a 40-day devotional journey and six weeks of small-group curriculum.</p>
      <p>Run one this season, or run all five over a year and watch the whole idea change shape in your
      congregation: from an annual appeal into a way of life.</p>
    </div>
  </section>

{"".join(card(c) for c in CAMPAIGNS)}

  <section class="thru">
    <h3>The through-line for a pastor.</h3>
    <p class="sub">Five campaigns, one deliberate progression — a full year of discipleship.</p>
    <div class="arc">
      <div class="arc-step" style="--ac:#1f3550"><div class="arc-n">1</div><div class="arc-t">Reframes</div><div class="arc-d">Life Stewardship moves it off the offering plate.</div></div>
      <div class="arc-step" style="--ac:#1f3a2c"><div class="arc-n">2</div><div class="arc-t">Anchors</div><div class="arc-d">Entrusted settles the identity beneath it.</div></div>
      <div class="arc-step" style="--ac:#15403f"><div class="arc-n">3</div><div class="arc-t">Wins</div><div class="arc-d">Stewarding What Matters takes the calendar.</div></div>
      <div class="arc-step" style="--ac:#46201f"><div class="arc-n">4</div><div class="arc-t">Builds</div><div class="arc-d">Faithful Stewardship forms the character.</div></div>
      <div class="arc-step" style="--ac:#4a3a16"><div class="arc-n">5</div><div class="arc-t">Lifts</div><div class="arc-d">Stewardship That Lasts opens the horizon.</div></div>
    </div>
    <div class="thru-body">
      <p>Run them in order and you have a full year of discipleship that ends with a church that gives —
      without a single guilt-driven sermon.</p>
    </div>
  </section>
  ...
  <footer class="close">
    ...
    <p>Five more campaigns round out the full Stewardship Collection — ten in all, each with a distinct
    biblical backbone, so a category never repeats itself.</p>
    <div class="cta">
  ...
  <div class="footbar">Brett Eastman &middot; Founder, Lifetogether &middot; brett@lifetogether.com &middot; The Stewardship Collection &middot; Top Five Featured</div>

</div>
</body>
</html>"""

OUT_HTML = "/mnt/user-data/outputs/Stewardship_Top5_Featured_Lifetogether.html"
OUT_PDF = "/mnt/user-data/outputs/Stewardship_Top5_Featured_Lifetogether.pdf"
